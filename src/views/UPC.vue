			...
			<el-row :gutter="20">
				...
				<el-col :span="12">
					<el-container style="height: 800px;">
						...
						<el-main>
							<el-input v-model="upcs_save" type="textarea" :rows="30" placeholder="请输入内容">
							</el-input>
						</el-main>
						<el-footer>
							<div>
								<el-row :gutter="10">
									...
									<el-col :span="10">
										<el-input v-model="pwd" show-password placeholder="请输入口令"></el-input>
									</el-col>
									<el-col :span="10">
										<el-button :disabled="save_btn_status.disable" @click="save_upc" type="primary">{{save_btn_status.title}}</el-button>
									</el-col>
								</el-row>
							</div>
						</el-footer>
	...
	export default {
		...
		methods: {
			...
			loadUPC() {
				...
				axios.get(`getupcs?count=${this.qty}`).then((e) => {
					console.log(e)
					if (e.ret != 0) {
						this.$alert(e.msg, '提示', {
							confirmButtonText: '确定',
